...
const {
  ...
  filtoBodyPut,
  filtroParamsDelete,
} = require("../utils/unidades/unidades.utils.js"); //Importa os utils deste controler
module.exports = {
  ...
  async postUnidades(req, res) {
    ...
    try {
      ...
      const unidade = await Unidades.create({
        nickname,
        address,
        brand,
        model,
        active,
      }); // Cria uma unidade com os dados do corpo da requisição
